...
\section{Projects}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      \resumeItem{Avatar Modeling}
          {Using \textit{Blender} to create user avatars and import into the scene created by Unity3D, 
          which includes modeling, sculpting and adding shader to the model.}
      \resumeItem{Script}
          {Adding user functions to the model using C\#, this inlcudes simulating movements, displaying emotion 
          create skeletal tracking on users' arm and fingers.}
    \resumeItemListEnd
