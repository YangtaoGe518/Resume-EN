...
\section{Work Experience}
  ...
  \resumeItemListStart
    \resumeItem{React Native Development}
      {Participated in the development of "ThinkNinja," an NHS-affiliated app designed to educate children about mental health, utilizing React Native and TypeScript. Successfully implemented multi-language support, significantly enhancing user accessibility and engagement.}
