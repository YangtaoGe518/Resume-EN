    ...
    \resumeItemListStart
        \resumeItem{Programming Languages}{
          \resumeSubItemListStart
            \resumeSubItem{Java}{Good proficiency in building scalable server-side applications using Spring framework and Gradle.}
            \resumeSubItem{Golang}{Proficient in building concurrent applications, primarily for microservices using Chi and Gin framework.}
            \resumeSubItem{Python}{Skilled in scripting and automation, as well as backend development in AWS lambda.}
        ...
        \resumeItem{Cloud Platform \& Tools}{
          \resumeSubItemListStart
            \resumeSubItem{AWS}{Experienced with EC2, SQS, S3, and Lambda for cloud-based applications.}
