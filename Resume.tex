...
\section{Work Experience}
  ...
  \resumeItemListStart
    \resumeItem{React Native Development}
      {Paticipate into the development of "ThinkNinja," an NHS-affiliated app for educating children about mental health, using React Native and TypeScript. Implemented multi-language support to enhance accessibility and user engagement.}
    \resumeItem{Code Quality and Efficiency}
      {Enhanced code robustness and maintainability by integrating TypeScript and ESLint, and improved development processes by configuring Redux for state management and Redux-Saga for asynchronous operations.}
    \resumeItem{Continuous Integration and Testing}
      {Intergate the TestFairy tool to streamline internal app distributions and implemented a continuous integration pipeline that reduced deployment cycles by 30\%, enhancing team productivity and app reliability}
  \resumeItemListEnd
