...
\section{Work Experience}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Corda Certificatied}
      {Qualifed from both internal examination and certification examination}
  \resumeItemListEnd
  \resumeSubheading
  {Healios}{London, UK}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItem{Machine Learning Research}
          {Investigating the relationship between parameters captured from the sensor and the dirtiness level by statatistical model and machine learning techniques
          and reserch the possibility using RNN to identify the garbage on the street from the CCTV images.}
    \resumeItemListEnd
    \resumeSubheading
